...
public class Strategie {
    ...
    public float venteProduit(String nomProduit, String marqueProduit, int quantiteDemandee){
    ...
    public float getPrixStrategiqueByQuantiteStockee(Produit p){
    ...
    public float getPrixStrategiqueByQuantiteDemandee(Produit p, int quantiteDemandee){
    ...
    public boolean assezQuantite(Produit p, int quantite){
